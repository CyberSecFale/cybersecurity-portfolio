...
| 📁 Project | 🧠 Summary |
|-----------|------------|
| 🔐 [Security Audit](projects/security-audit.md/README.md) | Performed a vulnerability review and remediation plan for a simulated small business. |
| 🧭 [Network Structure & Security Analysis](projects/network-analysis.md/README.md) | Mapped LAN architecture, identified threat surfaces, and improved segmentation. |
| 📁 [Linux File Permissions](projects/linux-permission.md/README.md) | Used `chmod`, `ls`, and `chown` to investigate and restrict improper access. |
| 🧮 [SQL Security Filters](projects/sql-filters.md/README.md) | Applied SQL queries to isolate risky login patterns and account abuse scenarios. |
| 🧪 [Vulnerability Assessment](projects/vulnerability-assessment.md/README.md) | Evaluated risk profile and weaknesses for a fictional business environment. |
| 🎣 [Incident Handler’s Journal](projects/incident-journal.md/README.md) | Tracked a simulated phishing attack using real IR journaling techniques. |
| 📄 [Resume](projects/resume.md/README.md) | A concise Markdown résumé outlining key skills, tools, and career focus. |
| 📄 [Professional Statement](projects/professional-statement.md/README.md) | Built with GitHub styling to reflect professionalism and personal vision. |
